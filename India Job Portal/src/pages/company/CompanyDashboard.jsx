...
import { Building, Users, Briefcase, PlusCircle, Layers, CheckCircle2 } from 'lucide-react';
          ...
          <div className={`p-5 sm:p-8 ${activeConfig.cardRadius} bg-gradient-to-r ${activeConfig.gradientBg} text-white space-y-4 shadow-xl`}>
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
              ...
              <motion.button 
                ...
                whileTap={{ scale: 0.96 }}
                onClick={() => setActivePage('company-post-job')} 
                className="w-full sm:w-auto px-4 py-2.5 bg-white text-slate-950 font-extrabold text-xs rounded-xl shadow-md flex items-center justify-center gap-1.5 transition-all"
              >
