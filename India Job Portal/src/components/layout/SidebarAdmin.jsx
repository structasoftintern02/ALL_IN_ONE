...
export const SidebarAdmin = ({ activePage, setActivePage, setActivePortal }) => {
  ...
  const menu = [
    { id: 'admin-dashboard', label: 'Platform Analytics', icon: LayoutDashboard },
    { id: 'admin-verify-company', label: 'Company GST Verification', icon: Building2, badge: '38 Pending' },
    { id: 'admin-verify-candidate', label: 'Candidate Verification', icon: ShieldCheck, badge: '142 Pending' },
    { id: 'admin-master', label: 'Master Data & Settings', icon: Database }
  ];
  ...
  return (
    <>
      ...
      <div className="block lg:hidden w-full bg-slate-950 text-white px-4 py-3 flex items-center justify-between border-b border-slate-800">
        <div className="flex items-center gap-2.5">
          ...
          <div>
            ...
            <span className="text-[9px] text-purple-300 font-bold">Platform Governance</span>
          </div>
        </div>
        <button
              ...
              <div className="flex items-center justify-between mb-6 pb-4 border-b border-slate-800">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <span className="text-[10px] text-purple-300 font-bold">Platform Governance</span>
                  </div>
                </div>
      ...
      <aside className="hidden lg:flex max-lg:hidden w-64 bg-slate-950 text-white border-r border-slate-800 p-4 min-h-screen flex-col justify-between flex-shrink-0">
        <div>
