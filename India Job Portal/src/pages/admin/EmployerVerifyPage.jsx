...
export const EmployerVerifyPage = ({ setActivePage, setActivePortal }) => {
            ...
            <table className="w-full text-left text-xs border-collapse min-w-[600px]">
              ...
              <tbody className="divide-y divide-slate-100">
                <tr className="hover:bg-slate-50">
                  <td className="py-3.5 px-4 font-bold text-slate-900">Razorpay Software Pvt Ltd</td>
                  <td className="py-3.5 px-4 font-mono text-slate-700">29AAAAA0000A1Z5</td>
                  <td className="py-3.5 px-4 text-slate-600">Bengaluru</td>
                  <td className="py-3.5 px-4 text-right">
                    <button onClick={() => alert('GST Approved!')} className="px-3 py-1.5 bg-purple-600 hover:bg-purple-700 text-white font-extrabold rounded-lg text-xs">
                      Approve GST Badge
                    </button>
                  </td>
                </tr>
