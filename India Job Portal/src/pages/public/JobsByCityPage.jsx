        ...
        {cityCardsData.map((city) => (
          <StaggerItem key={city.id} direction="up">
            <motion.div
              ...
              className={`group bg-white ${activeConfig.cardRadius} ${activeConfig.cardBorder} overflow-hidden space-y-4 shadow-sm hover:shadow-xl transition-all cursor-pointer h-full flex flex-col justify-between`}
            >
