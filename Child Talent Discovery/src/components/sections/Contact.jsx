  ...
  return (
    <section className="py-20 lg:py-28 bg-slate-50 dark:bg-slate-800/50" id="contact">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-14">
        ...
        <SectionHeader
          badge="📞 Get in Touch"
          title={<>Connect with Our <span className={`bg-gradient-to-r ${activeConfig.gradientText} bg-clip-text text-transparent`}>Child Talent Advisors</span></>}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10">
          ...
          <ScrollReveal direction="left" className="lg:col-span-7">
            <div className={`p-8 bg-white dark:bg-slate-800 ${activeConfig.cardRadius} shadow-xl border border-slate-100 dark:border-slate-800 space-y-6`}>
              <div className="flex items-center gap-2.5 border-b border-slate-100 dark:border-slate-700 pb-4">
                ...
                <h3 className="text-lg font-extrabold text-slate-900 dark:text-white">Parent Inquiry & Consultation Form</h3>
              </div>
              ...
              {submitted ? (
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  >
                    ...
                    <span>Send Message & Request Advisor Call</span>
                  </button>
                </form>
              )}
            </div>
          ...
          <ScrollReveal direction="right" className="lg:col-span-5 space-y-6">
              ...
              <div className="space-y-3 text-xs text-slate-600 dark:text-slate-300">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <div>1800-KIDS-TALENT (54378)</div>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <div>support@childtalentdiscovery.org</div>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <div>Child Development Center, Tech Park Phase 2, Outer Ring Road, Bengaluru – 560103</div>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className={`p-5 ${activeConfig.cardRadius} bg-amber-50 dark:bg-amber-950/30 border border-amber-200 dark:border-amber-900 space-y-2`}>
              ...
              <div className="space-y-1 text-xs text-slate-700 dark:text-slate-300">
                <div className="flex justify-between">
                  ...
                  <span className="font-extrabold">9:00 AM – 7:00 PM IST</span>
                </div>
                <div className="flex justify-between">
                  <span>Saturday:</span>
                  <span className="font-extrabold">10:00 AM – 4:00 PM IST</span>
                </div>
                <div className="flex justify-between text-slate-500">
                  <span>Sunday:</span>
                  <span>Online Parent Portal Open 24/7</span>
                </div>
              </div>
            </div>
            ...
            <div className={`h-48 ${activeConfig.cardRadius} bg-gradient-to-br from-purple-900 to-slate-900 border border-purple-800 relative overflow-hidden flex flex-col items-center justify-center text-center p-4 text-white shadow-md`}>
              ...
              <p className="font-extrabold text-sm">Child Talent Development Center</p>
              <p className="text-xs text-purple-300">Bengaluru, Karnataka 560103</p>
