    ...
    <div className="flex flex-col lg:flex-row min-h-screen w-full overflow-x-hidden">
      ...
      <div className="flex-1 p-4 sm:p-6 lg:p-8 space-y-6 sm:space-y-8 overflow-y-auto w-full min-w-0">
        ...
        <ScrollReveal direction="up" amount={0.2}>
          <div className={`p-6 ${activeConfig.cardBg} ${activeConfig.cardRadius} ${activeConfig.cardBorder} max-w-2xl space-y-4 text-xs shadow-sm`}>
            <div className="flex items-center gap-3 border-b border-slate-100 dark:border-gray-800 pb-4">
              <div className="w-12 h-12 rounded-2xl bg-emerald-500 text-slate-950 font-extrabold flex items-center justify-center text-lg shadow-md">
                AR
              </div>
              <div>
