...
export const PricingPlansPage = ({ setActivePage, setActivePortal }) => {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 space-y-10">
      ...
      {/* Header */}
      <ScrollReveal direction="down" className="text-center max-w-3xl mx-auto space-y-4">
        ...
        <div className="flex justify-center gap-2 pt-2">
          <motion.button
            ...
            className={`px-5 py-2.5 rounded-xl text-xs font-bold transition-all flex items-center gap-2 ${
              portalTab === 'company' ? `${activeConfig.buttonPrimary}` : 'bg-white border border-slate-200 text-slate-700 shadow-xs'
            }`}
          >
          ...
          <motion.button
            ...
            className={`px-5 py-2.5 rounded-xl text-xs font-bold transition-all flex items-center gap-2 ${
              portalTab === 'candidate' ? `${activeConfig.buttonPrimary}` : 'bg-white border border-slate-200 text-slate-700 shadow-xs'
            }`}
          >
