    ...
    <div className="flex flex-col lg:flex-row min-h-screen w-full overflow-x-hidden">
      ...
      <div className="flex-1 p-4 sm:p-6 lg:p-8 space-y-6 sm:space-y-8 overflow-y-auto w-full min-w-0">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-4xl">
          <div className={`p-6 ${activeConfig.cardBg} ${activeConfig.cardRadius} ${activeConfig.cardBorder} space-y-4`}>
            ...
            <button className={`w-full py-2.5 ${activeConfig.cardRadius} text-xs font-bold ${activeConfig.buttonPrimary}`}>
