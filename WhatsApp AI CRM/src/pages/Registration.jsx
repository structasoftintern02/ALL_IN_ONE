            ...
            <div className="flex items-center justify-between pt-4 border-t border-slate-100 dark:border-gray-800">
              {step > 1 ? (
                <button
                  ...
                  className="px-4 py-2.5 rounded-xl text-xs font-bold border border-slate-300 dark:border-gray-700 hover:bg-slate-100 dark:hover:bg-gray-800 flex items-center gap-1.5"
                >
