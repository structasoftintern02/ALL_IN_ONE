        ...
        <div className={`p-5 sm:p-8 ${activeConfig.cardRadius} bg-slate-900 text-white space-y-4 shadow-xl`}>
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
            ...
            <div className="flex flex-wrap items-center gap-2">
              <button onClick={() => setActivePage('admin-verify-teacher')} className="px-4 py-2.5 bg-teal-500 hover:bg-teal-600 text-slate-950 font-extrabold text-xs rounded-xl shadow-md">
