        ...
        {activeTab === 'overview' && (
          ...
          >
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
              ...
              <ScrollReveal direction="right" className={`lg:col-span-7 bg-white ${activeConfig.cardRadius} ${activeConfig.cardBorder} p-6 space-y-4 shadow-sm`}>
                ...
                <div className="space-y-3">
                  {mockUserData.recentPayments.map((pay) => (
                    <motion.div key={pay.id} whileHover={{ x: 4 }} className="p-3 bg-slate-50 rounded-xl border border-slate-100 flex items-center justify-between text-xs transition-all">
                      <div className="flex items-center gap-3">
              ...
              <ScrollReveal direction="left" className={`lg:col-span-5 bg-white ${activeConfig.cardRadius} ${activeConfig.cardBorder} p-6 space-y-4 shadow-sm`}>
                <div className="flex items-center justify-between border-b border-slate-100 pb-3">
